...
# if "input_filenames" not in columns:
...
# - **Be Hyper-Specific**: Provide detailed descriptions (e.g., "ornate elven plate armor, etched with silver leaf patterns" instead of "fantasy armor").
...
#         cursor.execute(
#             """
#             INSERT INTO generations (id, prompt, input_filenames, generated_filename, timestamp)
#             VALUES (?, ?, ?, ?, ?)
#             """,
#             (
#                 generation_id,
